...
Print[{{a1x,a1y},{b1x,b1y},{c1x,c1y}}//MatrixForm,{{m11,m12},{m21,m22}}//MatrixForm];
...
*)
F1a=Compile[{{p,_Real,2},{m,_Real,2}},
...
*)
(**)
F1v:=Compile[{{p,_Real,2},{m,_Real,2}},
...
ConstfixMatrix[n_,k_,l_,st_]:=n ConstMatrix[Length[st],k]+n ConstMatrix[Length[st],l]
-n ConstMatrix2[Length[st],k,l]-n ConstMatrix2[Length[st],l,k];
...
ARAPc=Compile[{{start,_Real,2},{target,_Real,2},{triangle,_Integer,2},{t,_Real}},
...
M=LocalAlexa[FindMatrix[s0,t0]][t]; En=F1a[s0,M];Vn=F1v[s0,M];
Do[Do[
...
(* constraint (l) *)
(*
gmatrix[[2l-1,2l-1]]=gmatrix[[2l-1,2l-1]]+1;
gmatrix[[2l,2l]]=gmatrix[[2l,2l]]+1;
uvector[[2l-1]]=uvector[[2l-1]]-2((1-t)start[[l,1]]+t target[[l,1]]);
uvector[[2l]]=uvector[[2l]]-2((1-t)start[[l,2]]+t target[[l,2]]);
*) 
